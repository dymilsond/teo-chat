      ...
      <div className="auth-page">
        <div className="auth-card">
          ...
          <div className="auth-success">
            ...
            <Link href="/login" className="btn-primary" style={{ display: 'block', textAlign: 'center', marginTop: '1.5rem' }}>
              Voltar para o login
            </Link>
          </div>
        </div>
  ...
  return (
    <div className="auth-page">
      <div className="auth-card">
        ...
        <p className="auth-subtitle">10 estudos por mês, sem precisar de cartão</p>
